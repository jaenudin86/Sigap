...
public class SPBUActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static String url_select 	 = SQLConnection.URL_BANTUAN_TERDEKAT_SPBU + "select_spbu.php";
    private static String url_insert 	 = SQLConnection.URL_BANTUAN_TERDEKAT_SPBU + "insert.php";
    private static String url_edit 	     = SQLConnection.URL_BANTUAN_TERDEKAT_SPBU + "edit.php";
    private static String url_update 	 = SQLConnection.URL_BANTUAN_TERDEKAT_SPBU + "update.php";
    private static String url_delete 	 = SQLConnection.URL_BANTUAN_TERDEKAT_SPBU + "delete.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        adapter = new Adapter(SPBUActivity.this, itemList);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(
            SPBUActivity.this, BantuanTerdekatActivity.class
        );
    ...
    private void DialogForm(String idx, String namax, String alamatx, String teleponx, String button) {
        dialog = new AlertDialog.Builder(SPBUActivity.this);
    ...
    private void simpan_update() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        Toast.makeText(SPBUActivity.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                        adapter.notifyDataSetChanged();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(SPBUActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        }) {
    ...
    private void Exit ()
    {
        ...
        btn_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 * */
                Intent intent = new Intent(SPBUActivity.this, BantuanTerdekatActivity.class);
                startActivity(intent);
            }
        });
    }
